...
VERSION_PACKAGE=github.com/ydcloud-dy/knowledgeBase.git/pkg/version
## 定义 VERSION 语义化版本号
...
build: tidy # 编译源码，依赖 tidy 目标自动添加/移除依赖包.
	@go build -v -ldflags "$(GO_LDFLAGS)" -o $(OUTPUT_DIR)/kl-apiserver $(PROJ_ROOT_DIR)/cmd/kl-apiserver/main.go
